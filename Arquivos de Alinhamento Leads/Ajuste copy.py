...
class JanelaControle(QWidget):
    def __init__(self):
        ...
        # --- Carrega .alg (FIXO) ---
        df = pd.read_csv("Coração .Alg/Patient_1.alg", header=None)
    ...
    def _calcular_fade_estatico(self):
        """
        Calcula um degradê fixo em RGBA por profundidade alongo do eixo de visão atual.
        ...
        # cinza: 50..255, alfa: 64..255  (ajuste se quiser mais/menos transparência)
